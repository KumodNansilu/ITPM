...
exports.bookSession = async (req, res) => {
  try {
    ...
    await createNotification({
      ...
      message: `${req.user.name || 'A student'} booked your session.`,
      link: '/sessions',
      metadata: { sessionId: String(session._id), appointmentId: String(appointment._id) }
    });
...
// Tutor: Delete session permanently (and related bookings)
exports.deleteSession = async (req, res) => {
  try {
    ...
    await Appointment.deleteMany({ tutorSession: sessionId });
